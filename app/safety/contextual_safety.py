...
class GroupSafetyUnavailableError(RuntimeError):
    """Raised when the contextual group safety gate cannot make a decision."""


class ModelGroupSafetyClassifier:
    def __init__(self, model_client, *, timeout_seconds: float = 5.0) -> None:
